module SwaggerClient
  # 
  class ContentSummary < BaseObject
    attr_accessor :content_id, :body_size, :third_party, :embedded, :url, :file_type, :age_in_seconds, :cached_for_seconds, :image_width, :image_height, :content_url, :content_url_guest
