module SwaggerClient
  # 
  class ContentDetail < BaseObject
    attr_accessor :improvements, :content_id, :body_size, :third_party, :embedded, :url, :file_type, :age_in_seconds, :cached_for_seconds, :image_width, :image_height, :content_url, :content_url_guest
    # attribute mapping from ruby-style variable name to JSON key
    def self.attribute_map
      {
        
        # All improvements possible for this content item
