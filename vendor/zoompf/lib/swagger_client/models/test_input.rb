module SwaggerClient
  # 
  class TestInput < BaseObject
    attr_accessor :name, :scan_type, :start_url, :start_url_list, :har_file_url, :device_type, :whitelist_domains, :defect_check_policy_id, :recurring
