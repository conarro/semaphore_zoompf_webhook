module SwaggerClient
  # 
  class DefectSummary < BaseObject
    attr_accessor :test_id, :snapshot_id, :defect_id, :severity, :name, :total_orig_size, :max_orig_size, :total_new_size, :max_new_size, :total_savings, :max_savings, :item_count, :defect_url, :defect_url_guest
