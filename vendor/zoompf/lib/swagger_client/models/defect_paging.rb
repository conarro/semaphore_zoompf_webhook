module SwaggerClient
  # 
  class DefectPaging < BaseObject
    attr_accessor :order_by, :order_asc, :page, :per_page
    # attribute mapping from ruby-style variable name to JSON key
    def self.attribute_map
      {
        
        # (Optional) Order By Field, defeaults to Severity
        :'order_by' => :'order_by',
    ...
    def order_by=(order_by)
      allowed_values = ["Severity", "Name", "TotalOrigSize", "MaxOrigSize", "TotalNewSize", "MaxNewSize", "TotalSavings", "MaxSavings", "ItemCount"]
