module SwaggerClient
  # 
  class DefectList < BaseObject
    attr_accessor :defects, :per_page, :total_count, :total_pages, :current_page, :previous_page, :next_page
    # attribute mapping from ruby-style variable name to JSON key
    def self.attribute_map
      {
        
        # A list of Performance Defects
        :'defects' => :'defects',
